// MFCExControl.cpp : Defines the initialization routines for the DLL.
//
...
static AFX_EXTENSION_MODULE MFCExControlDLL = { NULL, NULL };
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
	...
	if (dwReason == DLL_PROCESS_ATTACH)
	{
		...
		new CDynLinkLibrary(MFCExControlDLL);
