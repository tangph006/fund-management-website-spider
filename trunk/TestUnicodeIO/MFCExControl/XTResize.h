...
//     CXTResize
//
// <KEYWORDS xtResizeNoSizeIcon, xtResizeNoHorizontal, xtResizeNoVertical, xtResizeNoMinsize, xtResizeNoClipChildren, xtResizeNoTransparentGroup>
// -------------------------------------------------------------------
enum XTResize
{
	xtResizeNoSizeIcon         = 0x01, // Do not add size icon.
	xtResizeNoHorizontal       = 0x02, // No horizontal resizing.
...
// Obsolete
#define xtResizeNoHorisontal xtResizeNoHorizontal
...
//===========================================================================
class MFCEXCONTROL_API CXTResizeItem
{
public:
...
//     a sizing window.
//===========================================================================
class MFCEXCONTROL_API CXTSizeIcon : public CScrollBar
{
public:
	//-----------------------------------------------------------------------
	// Summary:
...
//===========================================================================
class MFCEXCONTROL_API CXTResize
{
public:
	...
	//          * <b>xtResizeNoHorizontal</b> No horizontal resizing.
...
protected:
	...
	//-----------------------------------------------------------------------
	virtual void AjustResizeRect(CSize& rcWindow);
