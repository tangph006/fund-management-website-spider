...
// TestUnicodeIO.cpp : Defines the class behaviors for the application.
//
...
// CTestUnicodeIOApp construction
...
// The one and only CTestUnicodeIOApp object

CTestUnicodeIOApp theApp;


// CTestUnicodeIOApp initialization
